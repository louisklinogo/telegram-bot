...
import { ToolResponse } from './notion';
...
export interface FinancialOperation {
  ...
  category?: 'Fabric' | 'Tailor Fee' | 'Transport' | 'Sale' | 'Supplies' | 'Rent' | 'Utilities' | 'Renovation' | 'Salary' | 'Food' | 'Miscellaneous';
  amount?: number;
  date?: string;
  payment_method?: 'Cash' | 'Mobile Money (Momo)' | 'Bank Transfer' | 'Debit Card' | 'Credit Card' | 'Check';
  linked_order?: string;
  notes?: string;
  receipt_file?: string;

...
Creating an invoice with universal business language uses the same parameters as the [Create Invoice PDF](https://invoice-generator.com/developers#create-invoice-pdf) endpoint.

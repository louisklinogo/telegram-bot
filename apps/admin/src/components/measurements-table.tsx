...
import { createColumns, type MeasurementColumn } from "@/app/measurements/columns";
...
export function MeasurementsTable({ measurements, isLoading, onEdit, onDelete }: MeasurementsTableProps) {

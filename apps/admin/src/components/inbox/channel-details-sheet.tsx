            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <span className="text-xs text-[#878787]">
                  {channel.category} • By Cimantikós
                </span>
              </div>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="absolute bottom-4 pt-8 border-t border-border">
              <p className="text-[10px] text-[#878787]">
                Cimantikós integrates with trusted communication platforms to help you
                manage customer conversations efficiently. We maintain high security
                standards and never share your data with third parties.
              </p>
            </div>
          </div>
        </SheetHeader>

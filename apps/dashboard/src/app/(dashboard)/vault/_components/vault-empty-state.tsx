      ...
      <div className="relative z-20 m-auto flex w-full max-w-[380px] flex-col">
        <div className="relative flex w-full flex-col text-center">
          ...
          <UploadDocumentDialog
            teamId={teamId}
            trigger={
              <button className="inline-flex items-center justify-center gap-2 rounded-md border border-input bg-background px-4 py-2 font-medium text-sm shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground">

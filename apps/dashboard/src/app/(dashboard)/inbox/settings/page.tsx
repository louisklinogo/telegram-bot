    ...
    <div className="border rounded-lg w-full flex flex-col hover:border-border transition-colors">
      ...
      <div className="px-6 pb-0 pt-4">
        <div className="flex items-center space-x-2 pb-4">
          ...
          {!active && (
            <span className="text-muted-foreground bg-secondary text-[10px] px-3 py-1 rounded-full font-mono">
              Coming soon
            </span>
          )}
        </div>
      ...
      <div className="px-6 text-xs text-muted-foreground pb-4 min-h-[60px] pt-0">{description}</div>

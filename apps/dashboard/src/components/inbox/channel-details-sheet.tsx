          ...
          <div className="flex items-center justify-between border-b border-border pb-2">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <span className="text-xs text-muted-foreground">{channel.category} • By Cimantikós</span>
              </div>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="absolute bottom-4 pt-8 border-t border-border">
              <p className="text-[10px] text-muted-foreground">
                Faworraintegrates with trusted communication platforms to help you manage
